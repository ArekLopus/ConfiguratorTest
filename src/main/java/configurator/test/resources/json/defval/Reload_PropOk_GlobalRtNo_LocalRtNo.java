...
// curl -i http://localhost:8080/ConfiguratorTest/res/config/PropBothGlobalRuntimeNoLocalRuntimeNo

// Change runtime first to set proper runtime check
// Ok json object from property file, global runtime check NO, local runtime check NO
// To check if properties are not reloaded twice - no reload here
@Path("/config")
public class Reload_PropOk_GlobalRtNo_LocalRtNo {
