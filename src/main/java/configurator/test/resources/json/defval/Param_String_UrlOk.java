...
// curl -i http://localhost:8080/ConfiguratorTest/res/config/StringUrlNameOk

// Parameterized type String, default value url name ok
@Path("/config")
public class Param_String_UrlOk {
