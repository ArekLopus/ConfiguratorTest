...
// curl -i http://localhost:8080/ConfiguratorTest/res/config/UrlGlobalRuntimeYesLocalRuntimeYes
...
@Path("/config")
public class Url_GlobalRtYes_LocalRtYes {
	...
	@Path("/UrlGlobalRuntimeYesLocalRuntimeYes")
	@GET
	...
	@Path("/UrlGlobalRuntimeYesLocalRuntimeYes/test")
	@GET
