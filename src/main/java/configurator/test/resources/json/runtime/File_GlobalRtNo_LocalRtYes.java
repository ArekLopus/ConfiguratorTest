...
// curl -i http://localhost:8080/ConfiguratorTest/res/config/FileGlobalRuntimeNoLocalRuntimeYes
...
@Path("/config")
public class File_GlobalRtNo_LocalRtYes {
	...
	@Path("/FileGlobalRuntimeNoLocalRuntimeYes")
	@GET
	...
	@Path("/FileGlobalRuntimeNoLocalRuntimeYes/test")
	@GET
