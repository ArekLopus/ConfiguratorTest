...
// curl -i http://localhost:8080/ConfiguratorTest/res/config/UrlGlobalRuntimeYesLocalRuntimeNo
...
@Path("/config")
public class Url_GlobalRtYes_LocalRtNo {
	...
	@Path("/UrlGlobalRuntimeYesLocalRuntimeNo")
	@GET
	...
	@Path("/UrlGlobalRuntimeYesLocalRuntimeNo/test")
	@GET
