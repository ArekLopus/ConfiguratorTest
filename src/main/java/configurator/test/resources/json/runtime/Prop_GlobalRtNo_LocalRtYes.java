...
// curl -i http://localhost:8080/ConfiguratorTest/res/config/PropGlobalRuntimeNoLocalRuntimeYes
...
public class Prop_GlobalRtNo_LocalRtYes {
	...
	@Path("/PropGlobalRuntimeNoLocalRuntimeYes")
	@GET
	public Response testGet() {
		return Response.ok("Ok json object from property file, global runtime check NO, local runtime check YES (always reloads): " + test).build();
	}
	
	@Path("/PropGlobalRuntimeNoLocalRuntimeYes/test")
	@GET
