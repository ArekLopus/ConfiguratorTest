...
// curl -i http://localhost:8080/ConfiguratorTest/res/config/UrlGlobalRuntimeYesLocalRuntimeUseGl
...
@Path("/config")
public class Url_GlobalRtYes_LocalRtUseGl {
	...
	@Path("/UrlGlobalRuntimeYesLocalRuntimeUseGl")
	@GET
	...
	@Path("/UrlGlobalRuntimeYesLocalRuntimeUseGl/test")
	@GET
