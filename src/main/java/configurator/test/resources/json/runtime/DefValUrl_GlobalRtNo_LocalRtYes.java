...
// curl -i http://localhost:8080/ConfiguratorTest/res/config/DefValUrlGlobalRuntimeNoLocalRuntimeYes
...
@Path("/config")
public class DefValUrl_GlobalRtNo_LocalRtYes {
