...
// curl -i http://localhost:8080/ConfiguratorTest/res/config/PropGlobalRuntimeYesLocalRuntimeNo (never reloads)
...
public class Prop_GlobalRtYes_LocalRtNo {
	...
	@Path("/PropGlobalRuntimeYesLocalRuntimeNo")
	@GET
	public Response testGet() {
		return Response.ok("Ok json object from property file, global runtime check YES, local runtime check NO (never reloads): " + test).build();
	}
	
	@Path("/PropGlobalRuntimeYesLocalRuntimeNo/test")
	@GET
