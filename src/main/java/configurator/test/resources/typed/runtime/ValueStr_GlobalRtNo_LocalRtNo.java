...
// curl -i http://localhost:8080/ConfiguratorTest/res/config/typedGlobalRuntimeNoLocalRuntimeNo
...
@Path("/config")
public class ValueStr_GlobalRtNo_LocalRtNo {
