...
// curl -i http://localhost:8080/ConfiguratorTest/res/config/typedDefValGlobalRuntimeNoLocalRuntimeYes
...
@Path("/config")
public class DefValStr_GlobalRtNo_LocalRtYes {
