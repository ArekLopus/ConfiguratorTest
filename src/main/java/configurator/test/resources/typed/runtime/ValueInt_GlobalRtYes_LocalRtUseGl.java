...
// curl -i http://localhost:8080/ConfiguratorTest/res/config/typedIntegerGlobalRuntimeYesLocalRuntimeUseGl
...
@Path("/config")
public class ValueInt_GlobalRtYes_LocalRtUseGl {
	...
	@Path("/typedIntegerGlobalRuntimeYesLocalRuntimeUseGl")
	@GET
	...
	@Path("/typedIntegerGlobalRuntimeYesLocalRuntimeUseGl/test")
	@GET
