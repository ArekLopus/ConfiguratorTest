...
// curl -i http://localhost:8080/ConfiguratorTest/res/config/typedIntegerGlobalRuntimeYesLocalRuntimeYes
...
@Path("/config")
public class ValueInt_GlobalRtYes_LocalRtYes {
