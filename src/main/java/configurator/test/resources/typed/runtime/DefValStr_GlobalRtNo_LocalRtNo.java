...
// curl -i http://localhost:8080/ConfiguratorTest/res/config/typedDefValGlobalRuntimeNoLocalRuntimeNo
...
@Path("/config")
public class DefValStr_GlobalRtNo_LocalRtNo {
