...
public class Byte_NameOk_DefValPropNameBadIT {
	...
	@Test
	public void typed_Byte_NameOk_DefValPropNameBad() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedParameterByteNameOkDefValPropertyBad/test");
