...
public class Byte_NameOkIT {
	...
	@Test
	public void typed_Byte_NameOk() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedParameterByteNameOk/test");
