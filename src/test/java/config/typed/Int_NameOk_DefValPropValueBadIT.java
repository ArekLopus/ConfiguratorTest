...
public class Int_NameOk_DefValPropValueBadIT {
	...
	@Test
	public void typed_Integer_NameOk_DefValPropValueBad() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedParameterIntegerNameOkDefValPropertyValueBad/test");
