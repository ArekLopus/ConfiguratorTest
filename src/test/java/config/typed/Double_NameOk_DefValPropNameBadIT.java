...
public class Double_NameOk_DefValPropNameBadIT {
	...
	@Test
	public void typed_Double_NameOk_DefValPropNameBad() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedParameterDoubleNameOkDefValPropertyBad/test");
