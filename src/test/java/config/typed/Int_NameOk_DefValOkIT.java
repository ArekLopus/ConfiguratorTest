...
public class Int_NameOk_DefValOkIT {
	...
	@Test
	public void typed_Integer_NameOk_DefValOk() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedParameterIntegerNameOkDefValOk/test");
		...
		assertThat(entity.getDefaultValue(), is(123));
