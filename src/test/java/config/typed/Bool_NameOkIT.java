...
public class Bool_NameOkIT {
	...
	@Test
	public void typed_Boolean_NameOk() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedParameterBooleanNameOk/test");
