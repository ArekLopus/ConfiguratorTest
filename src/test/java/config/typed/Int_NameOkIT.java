...
public class Int_NameOkIT {
	...
	@Test
	public void typed_Integer_NameOk() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedParameterIntegerNameOk/test");
