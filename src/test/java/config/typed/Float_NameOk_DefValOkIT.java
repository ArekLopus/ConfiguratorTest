...
public class Float_NameOk_DefValOkIT {
	...
	@Test
	public void typed_Float_NameOk_DefValOk() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedParameterFloatNameOkDefValOk/test");
		...
		assertThat(entity.getDefaultValue(), is(31.11F));
