...
public class Short_NameOkIT {
	...
	@Test
	public void typed_Short_NameOk() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedParameterShortNameOk/test");
