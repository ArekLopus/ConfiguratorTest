...
public class Long_NameOk_DefValBadIT {
	...
	@Test
	public void typed_Long_NameOk_DefValBad() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedParameterLongNameOkDefValBad/test");
