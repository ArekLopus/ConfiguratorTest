...
public class String_NameOk_DefValPropBadIT {
	...
	@Test
	public void typed_String_NameOk_DefValPropBad() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedParameterStringNameOkDefValPropertyBad/test");
