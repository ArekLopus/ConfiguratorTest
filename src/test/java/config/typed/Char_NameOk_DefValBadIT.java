...
public class Char_NameOk_DefValBadIT {
	...
	@Test
	public void typed_Character_NameOk_DefValBad() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedParameterCharacterNameOkDefValBad/test");
