...
public class String_DefValOkIT {
	...
	@Test
	public void typed_String_DefaultValueOk() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedParameterStringDefValOk/test");
