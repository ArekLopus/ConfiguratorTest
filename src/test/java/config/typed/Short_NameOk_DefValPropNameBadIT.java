...
public class Short_NameOk_DefValPropNameBadIT {
	...
	@Test
	public void typed_Short_NameOk_DefValPropNameBad() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedParameterShortNameOkDefValPropertyBad/test");
