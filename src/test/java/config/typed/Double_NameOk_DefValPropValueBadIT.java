...
public class Double_NameOk_DefValPropValueBadIT {
	...
	@Test
	public void typed_Double_NameOk_DefValPropValueBad() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedParameterDoubleNameOkDefValPropertyValueBad/test");
