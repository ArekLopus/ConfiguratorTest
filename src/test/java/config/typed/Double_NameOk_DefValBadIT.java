...
public class Double_NameOk_DefValBadIT {
	...
	@Test
	public void typed_Double_NameOk_DefValBad() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedParameterDoubleNameOkDefValBad/test");
