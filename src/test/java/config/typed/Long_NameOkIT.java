...
public class Long_NameOkIT {
	...
	@Test
	public void typed_Long_NameOk() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedParameterLongNameOk/test");
