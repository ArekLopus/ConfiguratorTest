...
public class Long_NameOk_DefValPropValueBadIT {
	...
	@Test
	public void typed_Long_NameOk_DefValPropValueBad() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedParameterLongNameOkDefValPropertyValueBad/test");
