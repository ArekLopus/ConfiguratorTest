...
public class Float_NameOk_DefValBadIT {
	...
	@Test
	public void typed_Float_NameOk_DefValBad() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedParameterFloatNameOkDefValBad/test");
