...
public class Short_NameOk_DefValBadIT {
	...
	@Test
	public void typed_Short_NameOk_DefValBad() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedParameterShortNameOkDefValBad/test");
