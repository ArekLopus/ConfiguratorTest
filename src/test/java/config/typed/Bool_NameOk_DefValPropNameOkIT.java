...
public class Bool_NameOk_DefValPropNameOkIT {
	...
	@Test
	public void typed_Boolean_NameOk_DefValPropNameOk() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedParameterBooleanNameOkDefValPropertyOk/test");
		...
		assertThat(entity.getDefaultValue(), is(true));
