...
public class Long_NameOk_DefValPropNameOkIT {
	...
	@Test
	public void typed_Long_NameOk_DefValPropNameOk() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedParameterLongNameOkDefValPropertyOk/test");
		...
		assertThat(entity.getDefaultValue(), is(7L));
