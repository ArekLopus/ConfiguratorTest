...
public class Char_NameOkIT {
	...
	@Test
	public void typed_Character_NameOk() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedParameterCharacterNameOk/test");
