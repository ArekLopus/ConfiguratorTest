...
public class Float_NameOk_DefValPropValueBadIT {
	...
	@Test
	public void typed_Float_NameOk_DefValPropValueBad() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedParameterFloatNameOkDefValPropertyValueBad/test");
