...
public class Char_NameOk_DefValOkIT {
	...
	@Test
	public void typed_Character_NameOk_DefValOk() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedParameterCharacterNameOkDefValOk/test");
		...
		assertThat(entity.getDefaultValue(), is('z'));
