...
public class Byte_NameOk_DefValOkIT {
	...
	@Test
	public void typed_Byte_NameOk_DefValOk() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedParameterByteNameOkDefValOk/test");
		...
		assertThat(entity.getDefaultValue(), is(Byte.valueOf("123")));
