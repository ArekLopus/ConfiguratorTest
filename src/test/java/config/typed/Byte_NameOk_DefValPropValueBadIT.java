...
public class Byte_NameOk_DefValPropValueBadIT {
	...
	@Test
	public void typed_Byte_NameOk_DefValPropValueBad() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedParameterByteNameOkDefValPropertyValueBad/test");
