...
public class Short_NameOk_DefValOkIT {
	...
	@Test
	public void typed_Short_NameOk_DefValOk() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedParameterShortNameOkDefValOk/test");
		...
		assertThat(entity.getDefaultValue(), is(Short.valueOf("321")));
