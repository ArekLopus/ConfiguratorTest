...
public class Bool_NameOk_DefValOkIT {
	...
	@Test
	public void typed_Boolean_NameOk_DefValOk() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedParameterBooleanNameOkDefValOk/test");
