...
public class ValueInt_GlobalYes_LocalUseGlIT {
	...
	public void typed_Integer_runtimeCheckTrue_AnnotationRuntimeCheckUseGlobal() {
		...
		WebTarget runtimeCheck = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedIntegerGlobalRuntimeYesLocalRuntimeUseGl/test");
