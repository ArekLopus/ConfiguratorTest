...
public class ValueStr_GlobalYes_LocalNoIT {
	...
	public void typed_String_runtimeCheckTrue_AnnotationRuntimeCheckNo() {
		...
		WebTarget runtimeCheck = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedGlobalRuntimeYesLocalRuntimeNo/test");
