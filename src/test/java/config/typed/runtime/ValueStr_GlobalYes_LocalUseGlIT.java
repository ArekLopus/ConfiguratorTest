...
public class ValueStr_GlobalYes_LocalUseGlIT {
	...
	public void typed_String_runtimeCheckTrue_AnnotationRuntimeCheckUseGlobal() {
		...
		WebTarget runtimeCheck = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedGlobalRuntimeYesLocalRuntimeUseGl/test");
