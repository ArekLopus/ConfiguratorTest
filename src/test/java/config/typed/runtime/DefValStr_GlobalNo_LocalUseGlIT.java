...
public class DefValStr_GlobalNo_LocalUseGlIT {
	...
	public void typed_String_DefVal_runtimeCheckFalse_AnnotationRuntimeCheckUseGlobal() {
...
//		WebTarget setPaths = client.target("http://localhost:8080/ConfiguratorTest/res/config/setPaths");
		...
		WebTarget runtimeCheck = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedDefValGlobalRuntimeNoLocalRuntimeUseGl/test");
