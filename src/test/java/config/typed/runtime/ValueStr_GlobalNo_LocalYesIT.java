...
public class ValueStr_GlobalNo_LocalYesIT {
	...
	public void typed_String_runtimeCheckFalse_AnnotationRuntimeCheckNo() {
...
//		WebTarget setPaths = client.target("http://localhost:8080/ConfiguratorTest/res/config/setPaths");
		...
		WebTarget runtimeCheck = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedGlobalRuntimeNoLocalRuntimeYes/test");
		...
		assertThat(entity.getValue(), is("This is a property from the file 'prop1.properties'"));
		...
		assertThat(entity.getValue(), instanceOf(String.class));
		assertThat(entity.getPropertyName(), is("testFileProp"));
		assertThat(entity.getValue(), is("testFileProp changed."));
