...
public class DefValDouble_GlobalNo_LocalNoIT {
	...
	public void typed_Double_DefVal_runtimeCheckFalse_AnnotationRuntimeCheckNo() {
		...
		WebTarget runtimeCheck = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedDoubleDefValGlobalRuntimeNoLocalRuntimeNo/test");
