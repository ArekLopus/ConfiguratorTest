...
public class DefValDouble_GlobalYes_LocalYesIT {
	...
	public void typed_Double_DefVal_runtimeCheckTrue_AnnotationRuntimeCheckYes() {
		...
		WebTarget runtimeCheck = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedDoubleDefValGlobalRuntimeYesLocalRuntimeYes/test");
