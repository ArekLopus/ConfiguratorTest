...
public class ValueStr_GlobalYes_LocalYesIT {
	...
	public void typed_String_runtimeCheckTrue_AnnotationRuntimeCheckYes() {
		...
		WebTarget runtimeCheck = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedGlobalRuntimeYesLocalRuntimeYes/test");
