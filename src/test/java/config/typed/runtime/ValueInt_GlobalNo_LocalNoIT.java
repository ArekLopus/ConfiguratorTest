...
public class ValueInt_GlobalNo_LocalNoIT {
	...
	public void typed_Integer_runtimeCheckFalse_AnnotationRuntimeCheckNo() {
		...
		WebTarget runtimeCheck = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedIntegerGlobalRuntimeNoLocalRuntimeNo/test");
