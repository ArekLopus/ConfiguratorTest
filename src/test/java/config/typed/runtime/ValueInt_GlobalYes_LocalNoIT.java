...
public class ValueInt_GlobalYes_LocalNoIT {
	...
	public void typed_Integer_runtimeCheckTrue_AnnotationRuntimeCheckNo() {
		...
		WebTarget runtimeCheck = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedIntegerGlobalRuntimeYesLocalRuntimeNo/test");
