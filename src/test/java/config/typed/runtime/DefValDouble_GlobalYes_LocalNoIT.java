...
public class DefValDouble_GlobalYes_LocalNoIT {
	...
	public void typed_Double_DefVal_runtimeCheckTrue_AnnotationRuntimeCheckNo() {
		...
		WebTarget runtimeCheck = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedDoubleDefValGlobalRuntimeYesLocalRuntimeNo/test");
