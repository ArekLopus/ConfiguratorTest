...
public class ValueStr_GlobalNo_LocalNoIT {
	...
	public void typed_String_runtimeCheckFalse_AnnotationRuntimeCheckNo() {
		...
		WebTarget runtimeCheck = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedGlobalRuntimeNoLocalRuntimeNo/test");
