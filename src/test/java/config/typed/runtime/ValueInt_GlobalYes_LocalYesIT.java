...
public class ValueInt_GlobalYes_LocalYesIT {
	...
	public void typed_Integer_runtimeCheckTrue_AnnotationRuntimeCheckYes() {
		...
		WebTarget runtimeCheck = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedIntegerGlobalRuntimeYesLocalRuntimeYes/test");
