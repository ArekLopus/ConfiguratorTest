...
public class DefValStr_GlobalYes_LocalNoIT {
	...
	public void typed_String_DefVal_runtimeCheckTrue_AnnotationRuntimeCheckNo() {
		...
		WebTarget runtimeCheck = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedDefValGlobalRuntimeYesLocalRuntimeNo/test");
