...
public class Long_NameOk_DefValPropNameBadIT {
	...
	@Test
	public void typed_Long_NameOk_DefValPropNameBad() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedParameterLongNameOkDefValPropertyBad/test");
