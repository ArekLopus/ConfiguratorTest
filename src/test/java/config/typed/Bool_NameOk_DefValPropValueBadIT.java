...
public class Bool_NameOk_DefValPropValueBadIT {
	...
	public void typed_Boolean_NameOk_DefValPropValueBad() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedParameterBooleanNameOkDefValPropertyValueBad/test");
