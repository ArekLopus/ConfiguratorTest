...
public class String_NameOk_DefValPropOkIT {
	...
	@Test
	public void typed_String_NameOk_DefValPropOk() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedParameterStringNameOkDefValPropertyOk/test");
