...
public class Double_NameOk_DefValOkIT {
	...
	@Test
	public void typed_Double_NameOk_DefValOk() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedParameterDoubleNameOkDefValOk/test");
