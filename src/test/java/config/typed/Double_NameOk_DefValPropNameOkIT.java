...
public class Double_NameOk_DefValPropNameOkIT {
	...
	@Test
	public void typed_Double_NameOk_DefValPropNameOk() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/typedParameterDoubleNameOkDefValPropertyOk/test");
