...
public class Prop_ENV_NameOkIT {
	...
	@Test
	public void simple_EnvVars_NameOk() {
		...
		WebTarget requestEnvVar = client.target("http://localhost:8080/ConfiguratorTest/res/config/propsEnvNameOk/test");
