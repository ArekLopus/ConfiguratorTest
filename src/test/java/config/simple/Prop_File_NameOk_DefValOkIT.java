...
public class Prop_File_NameOk_DefValOkIT {
	...
	@Test
	public void simple_File_NameOk_DefValOk() {
		
		WebTarget requestSystemProp = client.target("http://localhost:8080/ConfiguratorTest/res/config/propsFileNameOkDefValOk/test");
