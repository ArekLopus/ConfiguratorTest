...
public class Prop_System_NameBadIT {
	...
	@Test
	public void simple_System_NameBad() {
		
		WebTarget requestSystemProp = client.target("http://localhost:8080/ConfiguratorTest/res/config/propsSystemNameBad/test");
