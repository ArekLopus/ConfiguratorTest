...
public class Prop_System_NameOk_DefValOkIT {
	...
	@Test
	public void simple_System_NameOk_DefValOk() {
		...
		WebTarget requestSystemProp = client.target("http://localhost:8080/ConfiguratorTest/res/config/propsSystemNameOkDefValOk/test");
