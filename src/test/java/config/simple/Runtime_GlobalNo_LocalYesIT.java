...
public class Runtime_GlobalNo_LocalYesIT {
	...
	public void simple_runtimeCheckFalse_AnnotationRuntimeCheckNo() {
		...
		WebTarget runtimeCheck = client.target("http://localhost:8080/ConfiguratorTest/res/config/PropertiesGlobalRuntimeNoLocalRuntimeYes/test");
