...
public class Runtime_GlobalYes_LocalUseGlIT {
	...
	public void simple_runtimeCheckTrue_AnnotationRuntimeCheckUseGlobal() {
		...
		WebTarget runtimeCheck = client.target("http://localhost:8080/ConfiguratorTest/res/config/PropertiesGlobalRuntimeYesLocalRuntimeUseGl/test");
		...
		assertThat(entity, is("This is a property from the file 'prop1.properties'"));
		
		// after change check
		entity = checkAfterChangeResponse.readEntity(String.class);
		assertNotNull(entity);
		assertThat(entity, instanceOf(String.class));
		assertThat(entity, is("testFileProp changed."));
