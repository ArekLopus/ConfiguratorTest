...
public class Runtime_GlobalYes_LocalNoIT {
	...
	public void simple_runtimeCheckTrue_AnnotationRuntimeCheckNo() {
		...
		WebTarget runtimeCheck = client.target("http://localhost:8080/ConfiguratorTest/res/config/PropertiesGlobalRuntimeYesLocalRuntimeNo/test");
