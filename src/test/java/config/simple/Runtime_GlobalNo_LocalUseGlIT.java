...
public class Runtime_GlobalNo_LocalUseGlIT {
	...
	public void simple_runtimeCheckFalse_AnnotationRuntimeCheckUseGlobal() {
		...
		WebTarget runtimeCheck = client.target("http://localhost:8080/ConfiguratorTest/res/config/PropertiesGlobalRuntimeNoLocalRuntimeUseGl/test");
