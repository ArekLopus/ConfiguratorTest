...
public class Double_GetValueOrDefValIT {
	...
	@Test
	public void propertyTyped_getValueOrDefaultValue() {
		...
		assertThat(entity.getValueOrDefaultValue(), instanceOf(Double.class));
		assertThat(entity.getValueOrDefaultValue(), is(2.22));
