...
public class Field_privateIT {
	...
	@Test
	public void jsonObject_ClassMemberField_Private() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/jsonObjectFieldPrivate/test");
