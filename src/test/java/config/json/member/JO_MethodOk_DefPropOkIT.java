...
public class JO_MethodOk_DefPropOkIT {
	...
	@Test
	public void jsonObject_ClassMemberMethodNameOk_DefaultValuePropertyOk() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/jsonObjectClassMemberMethodOkDefPropNameOk/test");
