...
public class JO_FieldOk_DefValOkIT {
	...
	@Test
	public void jsonObject_ClassMemberField_NameOk_DefaultValueOk() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/jsonObjectClassMemberFieldOkDefValueOk/test");
