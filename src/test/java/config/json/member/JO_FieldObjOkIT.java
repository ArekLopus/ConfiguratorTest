...
public class JO_FieldObjOkIT {
	...
	@Test
	public void jsonObject_ClassMemberField_NameOk_Object() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/jsonObjectFieldObjNameOk/test");
