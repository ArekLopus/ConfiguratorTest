...
public class Method_GoesBeforeFieldIT {
	...
	@Test
	public void jsonObject_ClassMemberMethod_Before_ClassMemberField() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/MethodBeforeField/test");
