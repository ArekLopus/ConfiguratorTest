...
public class JO_FieldOk_DefUrlOkIT {
	...
	@Test
	public void jsonObject_ClassMemberField_NameOk_DefaultValueUrlOk() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/jsonObjectClassMemberFieldOkDefUrlNameOk/test");
