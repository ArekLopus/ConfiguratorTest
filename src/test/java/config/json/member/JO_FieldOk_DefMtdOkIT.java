...
public class JO_FieldOk_DefMtdOkIT {
	...
	@Test
	public void jsonObject_ClassMemberField_NameOk_DefaultValueClassMemberMethodOk() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/jsonObjectClassMemberFieldOkDefMethodNameOk/test");
