...
public class JO_MethodOk_DefValOkIT {
	...
	@Test
	public void jsonObject_ClassMemberMethodNameOk_DefaultValueOk() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/jsonObjectClassMemberMethodOkDefValueOk/test");
		...
		assertThat(entity.getDefaultValue().getString("error"), is("There was an error loading value."));
