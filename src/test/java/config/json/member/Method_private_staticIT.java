...
public class Method_private_staticIT {
	...
	@Test
	public void jsonObject_ClassMemberMethod_Private_Static() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/jsonObjectMethodPrivateStatic/test");
