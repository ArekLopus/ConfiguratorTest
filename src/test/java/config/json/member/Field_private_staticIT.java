...
public class Field_private_staticIT {
	...
	@Test
	public void jsonObject_ClassMemberField_Private_Static() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/jsonObjectFieldPrivateStatic/test");
