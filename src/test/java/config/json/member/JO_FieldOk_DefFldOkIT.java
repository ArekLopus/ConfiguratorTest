...
public class JO_FieldOk_DefFldOkIT {
	...
	@Test
	public void jsonObject_ClassMemberField_NameOk_DefaultValueClassMemberFieldOk() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/jsonObjectClassMemberFieldOkDefFieldNameOk/test");
