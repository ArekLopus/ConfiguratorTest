...
public class JO_FieldStrOk_ValBadIT {
	...
	@Test
	public void jsonObject_ClassMemberField_NameOk_ValueBad() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/jsonObjectFieldOkStrValueBad/test");
