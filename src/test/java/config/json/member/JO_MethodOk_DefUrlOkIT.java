...
public class JO_MethodOk_DefUrlOkIT {
	...
	@Test
	public void jsonObject_ClassMemberMethodNameOk_DefaultValueUrlOk() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/jsonObjectClassMemberMethodOkDefUrlNameOk/test");
