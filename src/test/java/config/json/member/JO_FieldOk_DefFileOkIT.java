...
public class JO_FieldOk_DefFileOkIT {
	...
	@Test
	public void jsonObject_ClassMemberField_NameOk_DefaultValueFileOk() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/jsonObjectClassMemberFieldOkDefFileNameOk/test");
