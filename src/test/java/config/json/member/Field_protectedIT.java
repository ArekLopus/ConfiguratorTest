...
public class Field_protectedIT {
	...
	@Test
	public void jsonObject_ClassMemberField_Protected() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/jsonObjectFieldProtected/test");
