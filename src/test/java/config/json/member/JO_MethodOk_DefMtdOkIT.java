...
public class JO_MethodOk_DefMtdOkIT {
	...
	@Test
	public void jsonObject_ClassMemberMethodNameOk_DefaultValueClassMemberMethodOk() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/jsonObjectClassMemberMethodOkDefMethodNameOk/test");
