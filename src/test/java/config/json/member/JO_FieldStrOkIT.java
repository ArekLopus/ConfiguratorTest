...
public class JO_FieldStrOkIT {
	...
	@Test
	public void sonObject_ClassMemberField_NameOk_String() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/jsonObjectFieldStrNameOk/test");
		...
		assertThat(entity.getValue().getString("strFieldKey1"), is("strFieldVal1"));
