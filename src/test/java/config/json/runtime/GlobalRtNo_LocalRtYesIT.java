...
public class GlobalRtNo_LocalRtYesIT {
	...
	public void runtimeCheckFalse_AnnotationRuntimeCheckYes() {
		...
		WebTarget runtimeCheck = client.target("http://localhost:8080/ConfiguratorTest/res/config/UrlGlobalRuntimeNoLocalRuntimeYes/test");
