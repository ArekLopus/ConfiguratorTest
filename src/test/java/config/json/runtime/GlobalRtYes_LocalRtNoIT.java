...
public class GlobalRtYes_LocalRtNoIT {
	...
	public void runtimeCheckTrue_AnnotationRuntimeCheckNo() {
		...
		WebTarget runtimeCheck = client.target("http://localhost:8080/ConfiguratorTest/res/config/UrlGlobalRuntimeYesLocalRuntimeNo/test");
