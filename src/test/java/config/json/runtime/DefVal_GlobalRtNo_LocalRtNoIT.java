...
public class DefVal_GlobalRtNo_LocalRtNoIT {
	...
	public void runtimeCheckFalse_AnnotationRuntimeCheckNo() {
		...
		WebTarget runtimeCheck = client.target("http://localhost:8080/ConfiguratorTest/res/config/DefValUrlGlobalRuntimeNoLocalRuntimeNo/test");
