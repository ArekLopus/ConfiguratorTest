...
public class DefVal_GlobalRtNo_LocalRtYesIT {
	...
	public void runtimeCheckFalse_AnnotationRuntimeCheckYes() {
		...
		WebTarget runtimeCheck = client.target("http://localhost:8080/ConfiguratorTest/res/config/DefValUrlGlobalRuntimeNoLocalRuntimeYes/test");
