...
public class GlobalRtYes_LocalRtUseGlIT {
	...
	public void runtimeCheckTrue_AnnotationRuntimeCheckUseGlobal() {
		...
		WebTarget runtimeCheck = client.target("http://localhost:8080/ConfiguratorTest/res/config/UrlGlobalRuntimeYesLocalRuntimeUseGl/test");
