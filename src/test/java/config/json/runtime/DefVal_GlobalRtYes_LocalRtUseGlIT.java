...
public class DefVal_GlobalRtYes_LocalRtUseGlIT {
	...
	public void runtimeCheckTrue_AnnotationRuntimeCheckUseGlobal() {
		
		WebTarget setRuntimecheckToTrue = client.target("http://localhost:8080/ConfiguratorTest/res/config/changeRuntime?runtime=true");
		WebTarget runtimeCheck = client.target("http://localhost:8080/ConfiguratorTest/res/config/DefValUrlGlobalRuntimeYesLocalRuntimeUseGl/test");
