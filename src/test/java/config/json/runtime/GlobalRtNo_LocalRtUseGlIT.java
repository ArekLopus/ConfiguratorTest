...
public class GlobalRtNo_LocalRtUseGlIT {
	...
	public void runtimeCheckFalse_AnnotationRuntimeCheckUseGlobal() {
		...
		WebTarget runtimeCheck = client.target("http://localhost:8080/ConfiguratorTest/res/config/UrlGlobalRuntimeNoLocalRuntimeUseGl/test");
