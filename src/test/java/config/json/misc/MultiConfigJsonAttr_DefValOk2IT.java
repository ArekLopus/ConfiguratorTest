...
public class MultiConfigJsonAttr_DefValOk2IT {
	...
	public void jsonObject_NoConfigJsonAttributes() {
		...
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/jsonObjectMultiValueAttributeDefVal2/test");
