...
public class Param_String_EmptyConfigJsonAttrIT {
	...
	public void jsonObject_NoConfigJsonAttributes() {
		...
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/stringEmptyValueAttribute/test");
