...
public class JO_PropKeyOk_ValueBadIT {
	...
	@Test
	public void jsonObject_Property_KeyOk_ValueBad() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/jsonObjectPropKeyOkValueBad/test");
