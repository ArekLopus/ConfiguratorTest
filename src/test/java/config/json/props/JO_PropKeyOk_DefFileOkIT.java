...
public class JO_PropKeyOk_DefFileOkIT {
	...
	@Test
	public void jsonObject_Property_KeyOk_DefaultValueFileOk() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/jsonObjectPropKeyOkDefFileNameOk/test");
