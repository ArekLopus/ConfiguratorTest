...
public class JO_PropKeyOk_DefFldOkIT {
	...
	@Test
	public void jsonObject_Property_KeyOk_DefaultValueClassMemberFieldOk() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/jsonObjectPropKeyOkDefFieldNameOk/test");
