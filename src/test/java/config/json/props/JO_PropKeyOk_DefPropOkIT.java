...
public class JO_PropKeyOk_DefPropOkIT {
	...
	@Test
	public void jsonObject_Property_KeyOk_DefaultValuePropertyOk() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/jsonObjectPropKeyOkDefPropNameOk/test");
