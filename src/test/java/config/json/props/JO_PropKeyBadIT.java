...
public class JO_PropKeyBadIT {
	...
	@Test
	public void jsonObject_Property_KeyBad() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/jsonObjectKeyBad/test");
