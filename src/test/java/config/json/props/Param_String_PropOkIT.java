...
public class Param_String_PropOkIT {
	...
	@Test
	public void jsonObject_Property_KeyOk_ParameterString() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/jsonObjectPropParameterStringKeyOk/test");
		...
		assertThat(entity.getValue(), startsWith("{\"keyProp1"));
