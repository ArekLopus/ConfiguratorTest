...
public class JO_PropKeyOk_DefMtdOkIT {
	...
	@Test
	public void jsonObject_Property_KeyOk_DefaultValueClassMemberMethodOk() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/jsonObjectPropKeyOkDefMethodNameOk/test");
