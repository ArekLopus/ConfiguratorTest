...
public class JO_UrlOk_DefFileOkIT {
	...
	@Test
	public void jsonObject_UrlOk_DefaultValueFileOk() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/jsonObjectUrlOkDefValFileNameOk/test");
