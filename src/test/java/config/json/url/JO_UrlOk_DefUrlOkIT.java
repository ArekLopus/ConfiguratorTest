...
public class JO_UrlOk_DefUrlOkIT {
	...
	@Test
	public void jsonObject_UrlOk_DefaultValueUrlOk() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/jsonObjectUrlOkDefValUrlNameOk/test");
