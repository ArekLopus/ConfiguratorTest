...
public class JO_UrlOk_DefMtdOkIT {
	...
	@Test
	public void jsonObject_UrlOk_DefaultValueClassMemberMethodOk() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/jsonObjectUrlOkDefValMethodNameOk/test");
