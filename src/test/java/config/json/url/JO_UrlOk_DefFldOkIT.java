...
public class JO_UrlOk_DefFldOkIT {
	...
	@Test
	public void jsonObject_UrlOk_DefaultValueClassMemberFieldOk() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/jsonObjectUrlOkDefValFieldNameOk/test");
