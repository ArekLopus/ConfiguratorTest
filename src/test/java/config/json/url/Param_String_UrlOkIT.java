...
public class Param_String_UrlOkIT {
	...
	@Test
	public void jsonObject_UrlOk_ParameterString() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/jsonObjectUrlParameterStringUrlOk/test");
		...
		assertThat(entity.getValue(), startsWith("{\"keyJaxRs1"));
