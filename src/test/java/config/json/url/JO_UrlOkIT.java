...
public class JO_UrlOkIT {
	...
	@Test
	public void jsonObject_UrlOk() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/jsonObjectUrlOk/test");
