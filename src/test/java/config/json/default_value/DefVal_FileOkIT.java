...
public class DefVal_FileOkIT {
	...
	@Test
	public void jsonObject_DefaultValueFile_NameOk() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/DefValFifeNameOk/test");
