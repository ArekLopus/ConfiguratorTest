...
public class Param_String_DefVal_MtdOkIT {
	...
	@Test
	public void jsonObject_DefaultValueClassMemberMethod_NameOk_ParameterString() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/StringMethodNameOk/test");
