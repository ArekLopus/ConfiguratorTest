...
public class Param_No_JOIT {
	...
	public void jsonObject_DefaultValue_ParameterNo() {
		...
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/jsonObjectDefaultValueParemeterNo/test");
		...
		assertThat(String.valueOf(entity.getDefaultValue()), startsWith("{\"error\":\"Field"));
