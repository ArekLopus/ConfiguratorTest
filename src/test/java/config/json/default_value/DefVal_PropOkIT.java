...
public class DefVal_PropOkIT {
	...
	@Test
	public void jsonObject_DefaultValueProperty_NameOk() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/DefValPropertyNameOk/test");
