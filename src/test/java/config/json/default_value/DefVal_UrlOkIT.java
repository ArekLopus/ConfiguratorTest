...
public class DefVal_UrlOkIT {
	...
	@Test
	public void jsonObject_DefaultValueUrl_NameOk() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/DefValUrlNameOk/test");
