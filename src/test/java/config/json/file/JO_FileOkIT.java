...
public class JO_FileOkIT {
	...
	@Test
	public void jsonObject_FilePath_NameOk() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/jsonObjectFileOk/test");
