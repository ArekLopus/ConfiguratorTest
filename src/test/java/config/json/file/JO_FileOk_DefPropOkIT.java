...
public class JO_FileOk_DefPropOkIT {
	...
	@Test
	public void jsonObject_FilePath_NameOk_DefaultValuePropertyOk() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/jsonObjectFileOkDefPropNameOk/test");
