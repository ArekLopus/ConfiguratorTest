...
public class Param_String_FileOkIT {
	...
	@Test
	public void jsonObject_FilePath_NameOk_ParameterString() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/StringParamFileNameOk/test");
		...
		assertThat(entity.getValue(), startsWith("{\"fileKey1"));
