...
public class JO_FileOk_DefFileOkIT {
	...
	@Test
	public void jsonObject_FilePath_NameOk_DefaultValueFileOk() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/jsonObjectFileOkDefFileNameOk/test");
