...
public class JO_FileOk_DefValOkIT {
	...
	@Test
	public void jsonObject_FilePath_NameOk_DefaultValueOk() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/jsonObjectFileOkDefValueOk/test");
