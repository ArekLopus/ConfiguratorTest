...
public class JO_FileOk_DefFldOkIT {
	...
	@Test
	public void jsonObject_FilePath_NameOk_DefaultValueClassMemberFieldOk() {
		
		WebTarget target = client.target("http://localhost:8080/ConfiguratorTest/res/config/jsonObjectFileOkDefFieldNameOk/test");
